...
"Date"                             return "DATE";
"now"                              return "NOW";
"daydate"                          return "DAYDATE";
"dayname"                          return "DAYNAME";
"day"                              return "DAY";
"month"                            return "MONTH";
...
"toWeeks"                          return "TOWEEKS";
"toYears"                          return "TOYEARS";
"toHours"                          return "TOHOURS";
"toMins"                           return "TOMINUTES";
"toSecs"                           return "TOSECONDS";
"@ruleCheck"                       return "EXECRULE";
...
ExecRuleStatement
    : "EXECRULE" "(" "IDENTIFIER" ")"
        {
            $$=new ExecRuleStatementNode($3,createSourceLocation(null,@1,@4));
        }
    ;
...
RelationalExpression
    ...
    | RelationalExpression "INARRAY" ShiftExpression
        {
            $$= new BinaryExpressionNode("inArray",$1,$3,createSourceLocation(null,@1,@3));
        }  
    ;
...
RelationalExpressionNoIn
    ...
    | RelationalExpressionNoIn "INARRAY" ShiftExpression
        {
            $$= new BinaryExpressionNode("inArray",$1,$3,createSourceLocation(null,@1,@3));
        }
    ;
...
RelationalExpressionNoBF
    ...
    | RelationalExpressionNoBF "INARRAY" ShiftExpression
        {
            $$= new BinaryExpressionNode("inArray", $1, $3,createSourceLocation(null, @1, @3));
        }
    ;
...
Literal
    ...
    | DateExpressionLiteral
    | DateConversionLiteral
    | ModelQueryExpressionLiteral
...
ModelAllFindsNode 
 	...
 	: "@M" "IDENTIFIER" "/" "{{" ModelAllFindLiterals "}}" "." "IDENTIFIER"
	   {
	  	$$=new ModelAllFindsNode($2,$5,null,'param',$8,createSourceLocation(null,$1,$8));
	   }
	|
	  "@M" "IDENTIFIER" "/" "{{" "IDENTIFIER" ":" ModelAllFindsWhereLiterals "}}" "." "IDENTIFIER"
	   {
	  	$$=new ModelAllFindsNode($2,$5,$7,'where',$10,createSourceLocation(null,$1,$10));
	   }
	 ;

ModelAllFindsWhereLiterals
	: ModelAllFindLiterals
	|
	"IDENTIFIER"
	{
		 $$ = new IdentifierNode($1, createSourceLocation(null, @1, @1));
...
ContextExpressionLiteral
    : "@CC" "." "IDENTIFIER"
        {
            $$=new ContextLiteralNode($3,null,createSourceLocation(null,@1,@3));
        }
    | "@CC" "." "IDENTIFIER" "." "IDENTIFIER"
        {
            $$=new ContextLiteralNode($3,$5,null,createSourceLocation(null,@1,@5));
        }
    ;

ModelQueryExpressionLiteral
    : ModelExpression WhereExpressionLiteral
        {
            $$=new ModelQueryExpression($1,$2,createSourceLocation(null,@1,@2));
        }
    ;

ModelExpression
    : ModelExpressionLiteral
    | ModelExpression "." "IDENTIFIER"
        {   
...
WhereExpressionLiteral
    : "@W" WhereExpression
        {
            $$=new WhereLiteralNode($2,createSourceLocation(null,@1,@2));
        }
    ;

WhereExpression
    : FilterExpression
    | FilterExpression DBLogicalOperator WhereExpression
        {
            $$=new ConditionalWhereExpression($1,$2,$3,createSourceLocation(null,@1,@3)); 
        }
    ;
...
DateLiteral
    : "DATE" "(" Literal ")"
        {
            $$=new DateLiteralNode($3,createSourceLocation(null,@1,@4));
        }
    | "DATE" "(" ElementList ")"
        {
            $$=new DateLiteralNode($3,createSourceLocation(null,@1,@4));
    ...
    | "DATE" "." "NOW"
        {
            $$=new DateLiteralNode("now",createSourceLocation(null,@1,@3));
        }
    ;
...
DateExpressionLiteral
    : DateLiteral
        {
            $$=new DateExpressionLiteralNode($1,"value",createSourceLocation(null,@1,@1));
        }
    | DateLiteral "." DateOperator
        {
            $$=new DateExpressionLiteralNode($1,$3,createSourceLocation(null,@1,@3));
        }
    ;

DateConversionLiteral
    : PrimaryExpressionNoBrace "." DateConversionOperator
        {
            $$=new DateConversionLiteralNode($2,$3,createSourceLocation(null,@1,@3));
        }
    ;
...
parser.ast.ModelAllFindsNode=ModelAllFindsNode;