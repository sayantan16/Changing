...
var exprLang = require('../../lib/expression-language.js');
...
module.exports = function PropertyExpressionMixin(Model) {
  ...
  log.debug(log.defaultContext(), 'PropertyExpressionMixin invoked for ', Model.modelName, 'prop expr ', propertyExpressions(Model));
  // get property expressions from property-expression-util
  Model.propertyUtils = propertyExpressions(Model);
