...
function getJWTConfig() {
  ...
  jwtConfig.secretOrKey = process.env.SECRET_OR_KEY ? sanitizePublicKey(process.env.SECRET_OR_KEY) : (jwtConfig.secretOrKey ? sanitizePublicKey(jwtConfig.secretOrKey) : 'secret');
  return jwtConfig;
}
