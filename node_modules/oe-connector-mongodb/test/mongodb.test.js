...
describe('mongodb connector', function() {
  ...
  xit('does not execute a nested `$where`', function(done) {
    Post.create({title: 'Post1', content: 'Post1 content'}, (err, p1) => {
      Post.create({title: 'Post2', content: 'Post2 content'}, (err2, p2) => {
        Post.create({title: 'Post3', content: 'Post3 data'}, (err3, p3) => {
  ...
  xit('findOrCreate should properly support field projection (on create) - object', function() {
  ...
  xit('findOrCreate should properly support field projection (on create) - array', function() {
